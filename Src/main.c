...
*/
  ...
  current_state = STATE_ACQUISITION; // forza lo stato per il debug
  ...
  while (1)
  {
    // DEBUG: verifica che printf funzioni
  printf("Heartbeat: loop in esecuzione\r\n");
  HAL_Delay(1000);
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  switch(current_state)
	  {
          ...
          { printf("Acquisizione interrotta dall'utente. Dati salvati in memoria.\n");
